          ...
          <Col md={6}>
            <div className="grid-item d-flex justify-content-center">
              <div className="about_subheading">
                ...
                <p className="info">
                  I&apos;m always eager to connect with like-minded individuals and explore new opportunities. Feel free to reach out to me at <a href="mailto:pratikmali242005@gmail.com" className="link_about" target="_blank">pratikmali242005@gmail.com</a> or connect with me on <a href="https://www.linkedin.com/in/pratikmali24/" className="link_about" target="_blank">LinkedIn</a>.
                </p>
              </div>
            </div>
          </Col>
