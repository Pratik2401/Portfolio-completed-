      ...
      <motion.div style={{ width: "100%" }}>
        <Row className="justify-content-center margin_body">
          <Col md={6} className="text-light margin_info">
            ...
            <motion.div className="link email justify-content-center" onClick={handleEmailClick} whileHover={{ scale: 1.05 }}>
            <svg width="22px" height="22px" viewBox="0 -2.5 20 20" xmlns="http://www.w3.org/2000/svg">
            ...
            <motion.div className="link linkedin justify-content-center" onClick={handleLinkedInClick} whileHover={{ scale: 1.05 }}>
            ...
            <motion.div className="link github justify-content-center" onClick={handleGitHubClick} whileHover={{ scale: 1.05 }}>
            ...
            <motion.div className="link leetcode justify-content-center" onClick={handleLeetCodeClick} whileHover={{ scale: 1.05 }}>
